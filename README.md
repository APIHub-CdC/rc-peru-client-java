...
En el archivo ApiTest.java, que se encuentra en ***src/test/java/io/rc/pe/client/api/***. Se deberá modificar los datos de la petición y de la URL para el consumo de la API en setBasePath("the_url"), como se muestra en el siguiente fragmento de código con los datos correspondientes:
